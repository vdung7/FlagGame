...
public class Main extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn1Player.setOnTouchListener(mDelayHideTouchListener);
		btn2Player.setOnTouchListener(mDelayHideTouchListener);
		
		btn1Player.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
				Toast.makeText(Main.this, "This function is not designed", Toast.LENGTH_SHORT).show();
			}
		});
		btn2Player.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(Main.this, InGame.class);
